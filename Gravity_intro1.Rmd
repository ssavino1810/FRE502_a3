...
author: "Jesus Davila- Sara Sabino- Adoracion Hernandez"
date: "10/2021"
output:
...
pacman::p_load(here, rjson, dplyr, ggplot2, gridExtra, kableExtra,reshape2,lubridate,tidyr,tidyverse, estimatr, psych,stargazer,dplyr,foreign,texreg,car)
```
```{r, include=FALSE}
here::here()
```
...
# install.packages("estimatr") # uncomment in order to install package
library(estimatr)
