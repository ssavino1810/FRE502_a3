...
TSPdataDS <- TSPdata[,c("trade","dist","gdp_exp","gdp_imp", "contig", "comlang_off", "colony", "comcol", "etcr_exp", "etcr_imp" )]
# CODE FOR QUESTION 1
...
plot1 <- ggplot(TSPdataDS, aes(x = logdistance, y = trade,)) +
 ...
 labs(y="Log(Distance)", x = "Trade") + # set names for axes
...
plot3 <- ggplot(TSPdataDS, aes(x=logdistance,
                        ...
                        theme_classic() + #no background
                        ggtitle("Log Distance vs Trade contiguity") +
                        theme(plot.title = element_text(hjust = 0.5)) + # put title in the middle
